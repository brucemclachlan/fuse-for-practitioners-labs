package com.mycompany.nextgate.test;
...
public class PersonEJBImpl implements PersonEJB {
    ...
    @Override
    public MatchColResult performEmpiRecordUpdate(CallerInfo callerInfo, SystemPerson sysObjBean) throws ProcessingException_Exception, UserException_Exception {
